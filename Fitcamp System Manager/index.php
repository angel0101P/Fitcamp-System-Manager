...
<head>
    ...
    <link rel="icon" href="images/LogominiFit.png">
...
<body>
    ...
    <div class="contenedor-imagen">
        <img src="images/LogominiFit.png" alt="Logo MiniFit">
    </div>
    ...
    <div class="contenedor">
        ...
        <div id="login" class="form-contenedor active">
            ...
            <form action="php/inicio_de_sesion.php" method="POST">
        ...
        <div id="registro" class="form-contenedor">
            <h2>Registrarse</h2>
            <form action="php/registro_de_usuarios.php" method="POST">
